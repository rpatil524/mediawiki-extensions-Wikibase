	...
	public static function provideGetDescriptions() {
		...
		return [
			...
			'local' => [
				'titles' => [ 1, 2, 3, 4, 5 ],
				'sources' => $local,
				'localDescriptions' => [ 1 => 'L1', 2 => 'L2', 3 => 'L3' ],
				'centralDescriptions' => [ 2 => false, 3 => 'C3', 4 => 'C4' ],
				'expectedDescriptions' => [ 1 => 'L1', 2 => 'L2', 3 => 'L3' ],
				'expectedActualSources' => [ 1 => $local, 2 => $local, 3 => $local ],
			],
			'local (array syntax)' => [
				'titles' => [ 1, 2, 3, 4, 5 ],
				'sources' => [ $local ],
			...
			'central' => [
				...
				'localDescriptions' => [ 1 => 'L1', 2 => 'L2', 3 => 'L3' ],
				'centralDescriptions' => [ 2 => false, 3 => 'C3', 4 => 'C4' ],
				'expectedDescriptions' => [ 3 => 'C3', 4 => 'C4' ],
				'expectedActualSources' => [ 3 => $central, 4 => $central ],
			],
			'local with central fallback' => [
				...
				'localDescriptions' => [ 1 => 'L1', 2 => 'L2', 3 => 'L3' ],
				'centralDescriptions' => [ 2 => false, 3 => 'C3', 4 => 'C4' ],
				'expectedDescriptions' => [ 1 => 'L1', 2 => 'L2', 3 => 'L3', 4 => 'C4' ],
				'expectedActualSources' => [ 1 => $local, 2 => $local, 3 => $local, 4 => $central ],
			],
			'central with local fallback' => [
				...
				'localDescriptions' => [ 1 => 'L1', 2 => 'L2', 3 => 'L3' ],
				'centralDescriptions' => [ 2 => false, 3 => 'C3', 4 => 'C4' ],
				'expectedDescriptions' => [ 1 => 'L1', 2 => 'L2', 3 => 'C3', 4 => 'C4' ],
				'expectedActualSources' => [ 1 => $local, 2 => $local, 3 => $central, 4 => $central ],
			],
		];
	}
